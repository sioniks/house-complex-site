                    ...
                    defaultConfig,
                    {
                        ...
                        message: function () {
                            ...
                            if (message == "Scss-files have been compiled") {
                                console.log('----------------- css -----------------');
                                gulp.src(['./../front_site/dev/static/css/**/*', '!./../front_site/dev/static/**/_*']).pipe(gulp.dest('./../master/frontend/web/static/css'));

                            }
                            else if (message == "Separate js files's been copied") {
                                console.log('----------------- js -----------------');

                                gulp.src(['./../front_site/dev/static/js/**/*', '!./../front_site/dev/static/**/_*']).pipe(gulp.dest('./../master/frontend/web/static/js'));
                                ...
                                gulp.src(['./../front_site/dev/static/img/**/*', '!./../front_site/dev/static/**/_*']).pipe(gulp.dest('./../master/frontend/web/static/img'));

                            }
                            else {
                                console.log('----------------- all -----------------');
                                gulp.src(['./../front_site/dev/static/**/*', '!./../front_site/dev/static/**/_*']).pipe(gulp.dest('./../master/frontend/web/static'));
                            }
