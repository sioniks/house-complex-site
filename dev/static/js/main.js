...
if ($('.by_year').length > 0) {
    var plusButton = function plusButton(n) {
        showButton(buttonIndex += n);
    };

    var showButton = function showButton(n) {
        var i;
...
function initMaps(mapMarkers) {
    ...
    var eachMarker = function eachMarker() {
